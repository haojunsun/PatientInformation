...
using PagedList;
using PatientInformation.Core;
using PatientInformation.Core.Services;
using PatientInformation.Infrastructure.Services;
using PatientInformation.Web.Helpers;
using PatientInformation.Core.Models;

namespace PatientInformation.Web.Areas.Admin.Controllers
{
